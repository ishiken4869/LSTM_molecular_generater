...
def train(dataset, model):
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        state_h, state_c = model.module.init_state(SEQUENCE_LENGTH)
        ...
        for batch, (x, y) in enumerate(dataloader):
            ...
            if batch < train_batch_num:
                ...
                test_loss = criterion(y_pred.transpose(1, 2), y.to(device))
...
fout = open('log_multi' + '_' + 'M' + str(MAX_EPOCHS) + '_' + 'B' + str(BATCH_SIZE) + '_' + 'L' + str(LEARNING_RATE) + '_' + 'N' + str(NROWS), 'wt')
...
model = model.to('cpu')
torch.save(model.state_dict(), 'model_multi' + '_' + 'M' + str(MAX_EPOCHS) + '_' + 'B' + str(BATCH_SIZE) + '_' + 'L' + str(LEARNING_RATE) + '_' + 'N' + str(NROWS) + '.pt')
...
plt.savefig("losses_graph_multi" + '_' + "M" + str(MAX_EPOCHS) + '_' + "B" + str(BATCH_SIZE) + '_' + 'L' + str(LEARNING_RATE) + '_' + "NROWS" + str(NROWS) + ".png")
